...
print("<script type='text/javascript' src='./js/help.js'></script>");
...
"answer"=>array("Fill in the spoken word section. Approximate how long you talked for, then delete the empty rows to be able to submit.<br><img src='images/SPOKENWORD.png'>", 
...
"Yes, you can add SAM plays one at a time by clicking the SAM plays button in the top right, the the '+' beside the track you want. You can also import all the songs from a period of time with the 'SAM period' button.<br><img src='images/SAMinPLAYSHEET.png'> ",
...
"Check the faders on the board for SAM A and SAM B are up and turned on, also make sure that 'Air' is lighter on Deck A, and 'Cue' is lighter on Deck B<br><img src='images/AIRandCUE.png'>", 
"Drag it to the queue, then to a deck and hit play. If a song you've dragged from the playlist is already playing on one deck, it will automatically load the top song in your playlist to the other deck so there is no dead air.<br><img src='images/ADDtoPLAYLIST.png'><br><img src='images/PLAYLISTtoDECK.png'>",
...
echo "<div class=QAcontainer id=QAcontainer".$i.">".$data[$i][title][0]."</div>";

for($j=0;$j<$numObjectsInside;$j++){
echo "<div class=QAelement id=QAelement".$i." name=element".$j." style='display:none;'>";
echo "<div class=QAquestion id=QAquestion".$i." name=QAquestion".$j.">Q: ".$data[$i][question][$j]."</div>";
