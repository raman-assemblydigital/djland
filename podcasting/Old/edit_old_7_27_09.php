...
//    $Prog_ID = get_param("programid", "string", "");
	...
	echo "<font size=2>Form revision date: 2006-11-01</font>";
	echo "</center>\r\n";
	...
	else
	{
		...
		$query_channels = "SELECT ChannelID, StringValue FROM `podcast_channels` WHERE FieldID = 1 ORDER BY StringValue";
	...
	if ($Channel_ID != "")
	{
		...
		{	
			...
			$sqlgetmarkers = "SELECT marker FROM podcast_timemarkers ORDER BY marker DESC LIMIT 30";
